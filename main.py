...
from PyQt6.QtWidgets import QApplication, QComboBox, QLabel, QMainWindow, QMessageBox, QStatusBar, QTableWidget, QTableWidgetItem, QVBoxLayout, QWidget, QGridLayout, QLineEdit, QPushButton, QMainWindow, QDialog, QToolBar
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """This Student Management System helps manage student records easily. It allows you to add, view, update, and delete student details like name, course, and contact number. Built with Python, PyQt6, and SQLite3, it provides a simple and user friendly interface for efficient data handling."""
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        courses = ["Biology", "Math", "Astronomy", "Physics", "Accounts"]
        ...
        button.clicked.connect(self.update_students)
